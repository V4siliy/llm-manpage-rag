...
ROOT_URLCONF = 'manpager_project.urls'
...
WSGI_APPLICATION = 'manpager_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'manpager'),
...
AUTHENTICATION_BACKENDS = [
    "django.contrib.auth.backends.ModelBackend",  # Default is fine; you verify tokens yourself
]

# Email configuration for development
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
# For file-based email backend (alternative):
